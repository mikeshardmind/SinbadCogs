...
class HTTPClient:
    ...
    async def request(
        self, route: Route, *, files: Optional[Iterable[File]] = ..., **kwargs: Any
    ) -> Any: ...
    ...
    def suppress_message_embeds(
        self, channel_id: int, message_id: int, *, suppress: bool = ...
    ) -> Coroutine[Any, Any, Any]: ...
    def add_reaction(
    ...
    def create_custom_emoji(
        self, guild_id: int, name: str, image: str, *, reason: Optional[str] = ...
    ) -> Coroutine[Any, Any, _EmojiDict]: ...
    def delete_custom_emoji(
        self, guild_id: int, emoji_id: int, *, reason: Optional[str] = ...
    ) -> Coroutine[Any, Any, None]: ...
    def edit_custom_emoji(
        self, guild_id: int, emoji_id: int, *, name: str, reason: Optional[str] = ...
    ) -> Coroutine[Any, Any, _EmojiDict]: ...
    def get_audit_logs(
        self,
        guild_id: int,
    ...
    def get_invite(self, invite_id: str) -> Coroutine[Any, Any, _InviteDict]: ...
    def invites_from(
        self, guild_id: int
